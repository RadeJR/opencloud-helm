...
OpenCloud is a cloud collaboration platform that provides file sync and share, document collaboration, and more. This Helm chart deploys OpenCloud with Keycloak for authentication, MinIO for object storage, and Collabora for document editing. For alternative document editors like OnlyOffice, you can use the external collaboration configuration.
...
graph TD
    ...
    subgraph "OpenCloud System"
        ...
        Collabora -->|WOPI Protocol| Collaboration[Collaboration Pod]
...
The `annotationsPreset` parameter helps configure ingress controller-specific features:
...
Check the logs of the Collabora pod:
